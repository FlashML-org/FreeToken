...
def load_batch_memcpy():
    """Build (once), probe, and return batch-memcpy entry point, or raise.

    ROCm uses its generic HIP copy kernel; CUDA uses 8-argument cudaMemcpyBatchAsync.
    The CUDA signature is CUDA 13.0's
