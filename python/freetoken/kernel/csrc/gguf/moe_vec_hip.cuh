...
// ggml/src/ggml-cuda/mmvq.cu; this file is the local HIP translation.
...
// Native mixed-Q5_K/Q6_K offload uses a uniform Q6_K row stride. Q5_K data
// occupies its native prefix; this kernel skips padding between rows/experts.
...
static void moe_vec_q5_K_q8_1_strided_cuda(
  ...
  const dim3 block_nums(block_num_y, 1, tokens * top_k);
  const dim3 block_dims(WARP_SIZE, GGML_CUDA_MMV_Y, 1);
  hipLaunchKernelGGL(( moe_vec_q_strided<scalar_t, QK_K, QI5_K, block_q5_K, VDR_Q5_K_Q8_1_MMVQ, vec_dot_q5_K_q8_1>),
...
static void moe_vec_q6_K_q8_1_strided_cuda(
  ...
  const dim3 block_nums(block_num_y, 1, tokens * top_k);
  const dim3 block_dims(WARP_SIZE, GGML_CUDA_MMV_Y, 1);
  hipLaunchKernelGGL(( moe_vec_q_strided<scalar_t, QK_K, QI6_K, block_q6_K, VDR_Q6_K_Q8_1_MMVQ, vec_dot_q6_K_q8_1>),
      dim3(block_nums), dim3(block_dims), 0, stream, vx, vy, dst, topk_ids,
      top_k, ncols, nrows, token_stride, expert_stride_bytes, row_stride_bytes);
}
