...
| P5 | Tail-latency matrix and 24-hour endurance | Long-context and 1/2/4/8-client tail controls complete. Initial saturation boundary observed at eight clients; endurance remains. |
